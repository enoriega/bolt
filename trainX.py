...
if __name__ == '__main__':
    ...
    params = {'loss': ['hinge', 'squared_hinge'], 'C': [0.01, 0.1, 1, 10, 100, 1000]}
    clf = GridSearchCV(PassiveAggressiveClassifier(), params) 
    test_classifier(clf, X_train, X_test, y_train, y_test)
    ...
    clf = GridSearchCV(ExtraTreeClassifier(), params)
    test_classifier(clf, X_train, X_test, y_train, y_test)
    ...
    params = {'loss': ['l1','l2'], 'C': [0.01, 0.1, 1, 10, 100, 1000]}
    clf = GridSearchCV(LinearSVC(), params)
    test_classifier(clf, X_train, X_test, y_train, y_test)

    params = {'kernel': ['rbf','poly','sigmoid','linear'], 'C': [0.01, 0.1, 1, 10, 100, 1000]}
